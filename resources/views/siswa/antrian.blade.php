            ...
            <div>
                ...
                <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="./antrian" aria-expanded="false">
                                <span>
                        ...
                        <div class="card-body">
                            <div class="d-sm-flex d-block align-items-center justify-content-between mb-9 gap-3">
                                ...
                                <a href="./antrian" type="button"
                                    class="btn btn-primary flex-grow-1">Antrian</a>
                                ...
                                <div>
                                    ...
                                    <div class="card" style="background-color: #e9ecef">
                                        <div class="card-body p-3 d-md-flex text-center">
                                            ...
                                            <div class="col-md-2">
                                                <h3 class="card-title text-truncate">
                                                    {{ $buku->denda != 0 ? 'Terkena Denda' : 'Menunggu Konfirmasi' }}</h3>
                                            </div>
                                            <div class="col-md-2">
                                                @if ($buku->denda == 0)
