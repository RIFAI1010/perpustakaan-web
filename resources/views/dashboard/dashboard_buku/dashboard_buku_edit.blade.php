    ...
    <form action="{{ route('dashboard_buku.update', $buku->id) }}" method="POST" enctype="multipart/form-data">
      ...
      <div class="row">
        ...
        <div class="col-12 col-md-6 col-lg-8 col-xl-9">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control @error('judul') is-invalid @enderror" id="judul" name="judul" value="{{ old('judul') ?? $buku->judul }}" required @required(true)>
            @error('judul')
              <div class="invalid-feedback">
                {{ $message }}
              </div>
      ...
      <div class="row">
        <div class="col-12 mb-3">
          ...
          <textarea name="deskripsi" class="form-control @error('deskripsi') is-invalid @enderror" id="deskripsi" cols="30" rows="10" required @required(true)>{{ old('deskripsi') ?? $buku->deskripsi }}</textarea>
          @error('deskripsi')
            <div class="invalid-feedback">
              {{ $message }}
            </div>
      ...
      <div class="row">
        <div class="col-12 col-md-4 col-lg-4 mb-3">
          ...
          <input type="number" class="form-control @error('isbn') is-invalid @enderror" id="isbn" name="isbn" minlength="10" maxlength="10" aria-describedby="isbnHelp" value="{{ old('isbn') ?? $buku->isbn }}" required @required(true)>
        ...
        <div class="col-12 col-md-4 col-lg-4 mb-3">
          ...
          <input type="number" class="form-control @error('jumlah_halaman') is-invalid @enderror" id="jumlah_halaman" name="jumlah_halaman" minlength="4" maxlength="4" value="{{ old('jumlah_halaman') ?? $buku->jumlah_halaman }}" required @required(true)>
