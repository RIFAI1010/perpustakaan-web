    ...
    <div>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link" href="/dashboard/petugas" aria-expanded="false">
                        <span>
                            <i class="ti ti-layout-dashboard"></i>
                        </span>
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link" href="/dashboard/category" aria-expanded="false">
                        <span>
                            <i class="ti ti-tag"></i>
                        </span>
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link" href="/dashboard/penulis" aria-expanded="false">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link" href="/dashboard/penerbit" aria-expanded="false">
                        <span>
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link" href="/dashboard/report-buku" aria-expanded="false">
                        <span>
                            <i class="ti ti-layout-dashboard"></i>
                        </span>
