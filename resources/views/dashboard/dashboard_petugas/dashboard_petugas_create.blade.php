...
<a href="/dashboard_petugas" class="btn btn-outline-primary mb-3">
  <i class="bi bi-0-square-fill-arrow-left"></i>
  Kembali
</a>

<div class="card">
  <div class="card-body">
    <h5 class="card-title fw-semibold">Form Tambah Petugas</h5>
    <form action="{{ route('dashboard_petugas.store') }}" method="POST" enctype="multipart/form-data">
      @csrf
      <div class="row">
